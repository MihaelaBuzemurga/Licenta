...
//
//        TextView textView=(TextView) findViewById(R.id.nume_utilizator);
//        textView.setText(m_user.getPrenume());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_allbooks) {
            fragmentManager.beginTransaction().replace(R.id.content_main,new AllBooksActivity()).commit();
            // Handle the camera action
        } else if (id == R.id.nav_uploadbook) {
            fragmentManager.beginTransaction().replace(R.id.content_main,new UploadBook()).commit();
